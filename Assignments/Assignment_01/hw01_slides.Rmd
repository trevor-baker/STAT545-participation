...
<font size="2"> Here is a brief summary of the integer and numeric columns: </font>  
...
<font size="2"> While Oceania is the richest continent on average, Kuwait, which is on the Asian continent, is the richest country overall. In the graph below, all countries with average income values greater than $50000 have been labelled. These include Kuwait, Norway, Singapore, and the United States. </font>   
...
<font size="2"> You can see general groupings of GDP and life expectancy by continent in the graph below. Also, there seems to be an asymptotic relationship between life expectancy and GDP. Mean life expectancy doesn't increase much beyond 80 years, no matter how rich the country. </font>
