...
2. Widen the data so that we see the number of words spoken by each race, by putting each type of race as its own column.
...
#i dont know how to work on original with one change. this seems ok:
experiment %>%
  pivot_longer(cols=c(-name, -trt, -rep),
               names_to=c("msmt_num"),
